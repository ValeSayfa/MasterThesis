...
<body>
  <div class="container-fluid" style="padding:30px">
    <div class="row">
      <div class="col-md-12">
        <h3><button onClick="self.close()" type="button" class="btn btn-link btn-lg">&lt;&lt; Back to Index Page</button></h3>
        ...
        <div class="row" style="margin-top:20px">
          ...
          <div class="col-md-4 text-center">
            <button class="btn btn-outline-success" name="sort" id="RelevanceSort" value="RelevanceSort" onclick="sortTable(5)">RelevanceSort
            </button>
          </div>
        </div>
      </div>
  ...
  <div class="row" style="padding:30px; margin-top:20px">
    <div class="col-md-12">
      <h4 id="ExcludedCount"></h4>
    </div>
  </div>
  <?php
    $excludedArray = searchExluded($conn);
    $conn->close();
  ?>
  <script>
    $(document).ready(function() {
      sortDescend(5) //Automatic sort table after page generated by match score
    });
  </script>
</body>
